...
/* harmony import */ var ng2_tel_input__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ng2-tel-input */ "./node_modules/ng2-tel-input/esm5/ng2-tel-input.js");
/* harmony import */ var ngx_stripe__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-stripe */ "./node_modules/ngx-stripe/fesm5/ngx-stripe.js");
...
/* harmony import */ var _angular_fire_messaging__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @angular/fire/messaging */ "./node_modules/@angular/fire/messaging/index.js");
/* harmony import */ var _angular_fire_database__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @angular/fire/database */ "./node_modules/@angular/fire/database/index.js");
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/index.js");
...
/* harmony import */ var _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! @ctrl/ngx-emoji-mart */ "./node_modules/@ctrl/ngx-emoji-mart/fesm5/ctrl-ngx-emoji-mart.js");
...
function getAuthServiceConfigs() {
    var config = new angular_6_social_login__WEBPACK_IMPORTED_MODULE_49__["AuthServiceConfig"]([
        {
...
var FooterComponent = /** @class */ (function () {
    function FooterComponent(fb, ApiService, af, toast, router, authService, http) {
        this.fb = fb;
    ...
    FooterComponent.prototype.ngOnInit = function () {
        ...
        $(".otp .otp-labl .otp1").keyup(function (e) {
            ...
            if (key == 8 || key == 46) {
                var is_first_child = $($(this).parent(".otp-labl")).is(":first-child");
                if (!is_first_child)
                    $(this)
                        .parent(".otp-labl")
                        .prev(".otp-labl")
    ...
    FooterComponent.prototype.onFileChanged = function (event) {
        this.selectedFile = event.target.files[0];
    };
    FooterComponent.prototype.moreEmp = function ($event) {
    ...
    FooterComponent.prototype.onUpload = function () {
        var uploadData = new FormData();
        uploadData.append("myFile", this.selectedFile, this.selectedFile.name);
        // console.log(this.selectedFile.name+ "selected file")
        // console.log(uploadData+ "upload data")
    };
    FooterComponent.prototype.create_personal_profile_pageform = function () {
    ...
    FooterComponent.prototype.onSubmit = function () {
        ...
        this.ApiService.login(datoToSend).subscribe(function (response) {
            _this.toast.success("You are successfully logged in");
            localStorage.setItem("Notification", "true");
            _this.ApiService.setUserData(response.data);
            ...
            _this.toast.error(error.error.message);
        });
    };
    //--------------------------LOADING CODE--------------------------------------
    FooterComponent.prototype.load_guest_number = function () {
        console.log("calling");
        $("#login").modal("hide");
        this.submitted = false;
    ...
    FooterComponent.prototype.load_guest_otp = function () {
        this.otpverification.otp1 = "";
        this.otpverification.otp2 = "";
        this.otpverification.otp3 = "";
        this.otpverification.otp4 = "";
    };
    FooterComponent.prototype.load_create_company_profile_page1 = function () {
    ...
    FooterComponent.prototype.load_create_company_profile_page2 = function () {
        this.api_get_bussiness_area();
    };
    FooterComponent.prototype.getemp = function () {
    ...
    FooterComponent.prototype.load_create_personal_profile_page1 = function () {
        //HERE******************
        this.create_personal_profile_pageform();
    ...
    // }
    //-------------------------VALIDATION CODE--------------------------------
    FooterComponent.prototype.validate_create_company_profile_page1 = function () {
    ...
    FooterComponent.prototype.validate_create_company_profile_page2 = function () {
    ...
    // on image select
    FooterComponent.prototype.CheckUploadedImage = function (event) {
        var e_1, _a;
    ...
    FooterComponent.prototype.CheckUploadedImage2 = function (event) {
        var e_2, _a;
        var file = event.target.files[0];
        var fileType = file["type"];
        var validImageTypes = ["image/gif", "image/jpeg", "image/png"];
            ...
            if (singleFiles) {
                try {
                    for (var singleFiles_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](singleFiles), singleFiles_2_1 = singleFiles_2.next(); !singleFiles_2_1.done; singleFiles_2_1 = singleFiles_2.next()) {
                        var file_2 = singleFiles_2_1.value;
                        var singleReader = new FileReader();
                        singleReader.onload = function (e) {
                            $("#previewCompanyImg").attr("src", e.target.result);
                        };
                        singleReader.readAsDataURL(file_2);
                    }
                }
    ...
    FooterComponent.prototype.validate_create_personal_profile_page1 = function () {
    ...
    //---------------------------------API CALLING CODE----------------------------------
    FooterComponent.prototype.api_get_auto_detect_country_code = function () { };
    FooterComponent.prototype.api_get_country_code = function () {
        var _this = this;
        this.ApiService.get_country_code().subscribe(function (response) {
            console.log(response.data);
            _this.country_code = response.data;
            // Auto Detect country code-----------------------------------
            _this.ApiService.auto_detect_country_code().subscribe(function (response2) {
                console.log(response2);
                response.data.forEach(function (element) {
                    if (element.country_code == response2.countryCode) {
                        console.log(response2.countryCode, "sdasdad----------------");
                        _this.gustregister.patchValue({ country_code: element.code });
                    }
                });
            }, function (error) {
    ...
    FooterComponent.prototype.guest_register = function () {
        var _this = this;
        this.submitted = true;
        if (this.gustregister.valid) {
            console.log(this.gustregister);
            this.ApiService.guest_login(this.gustregister.value).subscribe(function (response) {
                // this.toast.success(response.message)
                if (response.data.verification_code) {
                    _this.load_guest_otp();
                    _this.otpverification.orginal_verification_code =
                    ...
                    if (response.data.is_num_verify &&
                        ...
                        _this.toast.success("OTP verified");
                        $("#guest-number").modal("hide");
    ...
    FooterComponent.prototype.api_otp_verification = function () {
        var _this = this;
        ...
        this.ApiService.otp_verify(send_data).subscribe(function (response) {
            _this.otpverification.otp1 = "";
            _this.otpverification.otp2 = "";
            _this.otpverification.otp3 = "";
            _this.otpverification.otp4 = "";
            $("#create_profile_link").removeClass("hide-me");
            $("#login_link").removeClass("show-me").addClass("hide-me");
            $("#gpsforlogin").modal("show");
    ...
    FooterComponent.prototype.api_get_bussiness_area = function () {
        var _this = this;
        this.ApiService.get_bussiness_area().subscribe(function (response) {
            console.log(response.data, "select area");
            _this.bussiness_area = response.data;
        }, function (error) {
            console.log("error", error);
            _this.loginError(error.error.message);
        });
    };
    FooterComponent.prototype.api_get_profession = function () {
        var _this = this;
        this.ApiService.get_profession().subscribe(function (response) {
            console.log(response.data);
            _this.profession = response.data;
        }, function (error) {
            console.log("error", error);
            _this.loginError(error.error.message);
        });
    };
    FooterComponent.prototype.api_create_company_profile = function () {
        var _this = this;
        ...
        this.ApiService.postCreateProfile(data).subscribe(function (response) {
    ...
    FooterComponent.prototype.userState = function () {
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.userId = this.userData.id;
    ...
    FooterComponent.prototype.api_get_address_from_lat_long = function (lat, long) {
        var _this = this;
        // console.log(lat);
        // console.log(long);
        this.lat_toSend = lat;
        this.lon_toSend = long;
        this.ApiService.getAddressFromLatLng(lat + "," + long).then(function (result) {
            ...
            _this.create_company_profile_page2.controls["address_line1"].setValue(locations[0].Location.Address.Label);
    ...
    FooterComponent.prototype.api_create_personal_profile = function () {
        var _this = this;
    ...
    //     });
    FooterComponent.prototype.GetAddressEvent = function (event) {
        var _this = this;
        ...
        window.navigator.geolocation.getCurrentPosition(function (data) {
            ...
            _this.ApiService.getAddressNew({
                ...
                _this.create_company_profile_page2.patchValue({
                    address_line1: _this.companyAddress,
                });
            });
            var myCord = JSON.parse(JSON.stringify(data.coords));
            ...
            if (lat && long) {
                console.log(lat);
                console.log(long);
                _this.api_get_address_from_lat_long(lat, long);
            }
            else {
                console.log("no lat long found");
                // $("#gps").modal("show");
                _this.loginError("Unable to access your location");
                // window.location.reload();
                $("#location").modal("hide");
            }
        });
    };
    FooterComponent.prototype.getCurrentLocation = function () {
        var _this = this;
        $("#custom_location").html("");
        window.navigator.geolocation.getCurrentPosition(function (data) {
            console.log(data);
    ...
    FooterComponent.prototype.getCurrentLocationForLogin = function () {
        var _this = this;
        $("#custom_location").html("");
        window.navigator.geolocation.getCurrentPosition(function (data) {
            console.log(data);
    ...
    FooterComponent.prototype.deniedLocation = function () {
        location.reload();
    };
    FooterComponent.prototype.checkGPSStatus = function () {
        var _this = this;
        this.ApiService.getCurrentLocation().then(function (data) {
            console.log(data, "======958 click to location=============");
            $("#location").modal("show");
        }, function (error) {
            console.log(error);
            _this.toast.error("Unable to access your current location Because you blocked it. Please set marker manually to current location");
            // $('#location').modal('show')
        });
    };
    FooterComponent.prototype.resend_otp = function () {
        $("#guest-number").modal("show");
        $("#guest-otp").modal("hide");
    };
    FooterComponent.prototype.open_create_company_profile_page1 = function () {
        this.profile_type = 2;
    ...
    FooterComponent.prototype.submit_create_company_profile_page1 = function () {
        // this.profile_type = 1
        // localStorage.setItem('profile_type', String(this.profile_type))
    ...
    FooterComponent.prototype.submit_create_company_profile_page2 = function (e) {
        var _this = this;
        console.log(this.profile_type, this.create_company_profile_page1.value, this.create_company_profile_page2.value);
        var newObj1 = JSON.parse(JSON.stringify(this.create_company_profile_page1.value));
        var newObj2 = JSON.parse(JSON.stringify(this.create_company_profile_page2.value));
        var newObj = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, newObj1, newObj2);
    ...
    FooterComponent.prototype.submit_create_company_profile_page3 = function (e) {
        if (this.validate_create_company_profile_page1()) {
            if (this.validate_create_company_profile_page2()) {
                this.api_create_company_profile();
            }
    ...
    FooterComponent.prototype.checkValue = function (event) {
        console.log(event.target.checked);
        this.checkValueStatus = event.target.checked;
    };
    FooterComponent.prototype.open_create_personal_profile_page1 = function () {
        this.profile_type = 1;
        console.log(this.profile_type);
        localStorage.setItem("profile_type", String(this.profile_type));
        console.log(this.profile_type);
    ...
    FooterComponent.prototype.submit_create_personal_profile_page1 = function (e) {
        if (this.validate_create_personal_profile_page1()) {
            this.api_create_personal_profile();
        }
    };
    //-------------------------------API ERROR HANDLING CODE---------------------------------
    FooterComponent.prototype.loginError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    FooterComponent.prototype.sendFeedback = function () {
        var _this = this;
        if (Boolean(this.feedback) == false) {
            this.toast.error("feedback is required");
            return;
        }
        this.ApiService.sendUserFeedback({ feedback: this.feedback }).subscribe(function (res) {
            _this.toast.success(res["message"]);
            _this.feedback = "";
            $("#close-feedbackModal").click();
        }, function (error) {
            _this.toast.error(error.error.feedback);
        });
    };
    FooterComponent.prototype.signInWithGoogle = function () {
        var _this = this;
        this.authService
    ...
    FooterComponent.prototype.signInWithFB = function () {
        // this.authService
    ...
    FooterComponent.prototype.signUp = function () {
        ...
        var status = re.test(String(email).toLowerCase());
        if (status == false) {
    ...
    FooterComponent.prototype.forgotPass = function () {
        var _this = this;
        ...
        if (status == false) {
            ...
            this.ApiService.guest_resetPassword({ email: email }).subscribe(function (res) {
                _this.toast.success("Password rest link sent");
                $("#forgot-password").modal("hide");
            }, function (error) {
                _this.toast.error("Email not registered");
            });
        }
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(ApiService, toast, router, af, dataSource) {
        this.ApiService = ApiService;
        this.toast = toast;
        this.router = router;
        this.af = af;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.dataSource.currentData.subscribe(function (message) { return (_this.message = message); });
    };
    HeaderComponent.prototype.searchPost = function () {
        var _this = this;
        var ss;
        this.ApiService.searchPost(ss).subscribe(function (res) {
            _this.searchList = res["data"];
        });
    };
    HeaderComponent.prototype.ifSubscribe = function () {
    ...
    HeaderComponent.prototype.logout = function () {
        ...
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.userId = this.userData.id;
        this.ApiService.getlogout().subscribe(function (res) {
            ...
            var timestamp = new Date().getTime().toString();
            var dataTosaveRecent = {
                id: _this.userId,
                name: _this.userData.company_detail["name"],
                profile_image: _this.userData.company_detail["picture"],
                onlineState: "0",
                timeStamp: timestamp,
            };
            _this.af.database
                .ref("/userState/" + _this.userId.toString())
    ...
    HeaderComponent.prototype.handleAddressChange = function (address) {
        var _this = this;
        this.lat = address.geometry.location.lat();
        this.lng = address.geometry.location.lng();
        console.log("latitude = " + this.lat + ", longitude = " + this.lng);
        var data = { lat: this.lat, lng: this.lng, searched: true };
...
var AboutUsComponent = /** @class */ (function () {
    ...
    AboutUsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.a().subscribe(function (x) {
            _this.htmlString = x.data[0].content;
...
var ChatInsightComponent = /** @class */ (function () {
    function ChatInsightComponent(af, api, Toast, activatedRoute) {
        this.af = af;
        this.api = api;
        this.Toast = Toast;
    ...
    ChatInsightComponent.prototype.singleFile = function (event) {
    ...
    ChatInsightComponent.prototype.sendFilesInChat = function () {
        var _this = this;
        var data = new FormData();
        ...
        // }
        this.api.sendImageInChat(data).subscribe(function (res) {
            _this.imageChatResponse = res["data"];
            _this.fileName = _this.imageChatResponse["file"].toString();
            // (environment.baseUrl  + this.imageChatResponse['file'].toString().slice(1, )).toString()
            console.log(_this.fileName, "gggg");
        });
    };
    ChatInsightComponent.prototype.removeImage = function () {
        this.file = null;
        this.fileImg = false;
        this.fileName = null;
    ...
    ChatInsightComponent.prototype.getRecent = function () {
        var that = this;
        this.af.database
    ...
    // }
    ChatInsightComponent.prototype.sendMessage = function () {
        var _this = this;
        var timestamp = new Date().getTime().toString();
        var toName = this.ChatUserList.find(function (a) {
            return a.id == _this.chatId;
        });
    ...
    ChatInsightComponent.prototype.getList = function () {
        var _this = this;
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.userId = this.userData.id;
        ...
        this.af
            ...
            _this.AllMessagelists = data;
            //this.userChat = data;
            console.log(_this.AllMessagelists, "AllMessageList");
        });
    };
    ChatInsightComponent.prototype.BlockChatUser = function (val) {
        if (val == "1") {
            this.dataBlocked = {
                blocked: val,
            };
    ...
    ChatInsightComponent.prototype.getProfile = function () {
        var _this = this;
        this.af
            ...
            _this.ProfileName = _this.ProfileData[1];
            _this.ProfileonlineStatus = _this.ProfileData[2];
            _this.ProfileImage = _this.ProfileData[3];
            //this.userChat = data;
            console.log(_this.ProfileData, "ProfileData");
        });
    };
    ChatInsightComponent.prototype.getSingleUserChat = function () {
        var _this = this;
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.userId = this.userData.id;
        if (this.userId < this.chatId) {
            this.af
                ...
                console.log(_this.SingleUserChat, "SingleUserChat");
            });
        }
        if (this.userId > this.chatId) {
            this.af
    ...
    ChatInsightComponent.prototype.addEmoji = function (event) {
        if (this._message) {
    ...
    ChatInsightComponent.prototype.getChatUser = function () {
        var _this = this;
        this.af
            .list("/userState")
            .valueChanges()
            .subscribe(function (data) {
            _this.chatUserarr = [];
            _this.userStateData = data;
            var _loop_1 = function (index) {
                x = _this.userStateData.find(function (f) {
                    return _this.AllMessagelists[index].id == f.id;
                });
                if (x)
                    _this.chatUserarr.push(x);
            };
            var x;
            for (var index = 0; index < (_this.AllMessagelists || []).length; index++) {
                _loop_1(index);
            }
            var arr = _this.AllMessagelists.filter(function (e) {
                return _this.userStateData.filter(function (f) {
                    return e.id == f.id;
                });
            });
        });
    ...
    ChatInsightComponent.prototype.getChat = function (user) {
        var _this = this;
        this.userData = user;
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.path = "message/";
        this.db
            ...
            .subscribe(function (data) {
            _this.userChat = data;
            console.log(_this.userChat, "asdddddddddd");
            $("#chatUser").show();
        });
    };
    ChatInsightComponent.prototype.getChatUserList = function () {
        var _this = this;
        this.api.getChatUsers().subscribe(function (a) {
            _this.ChatUserList = a["data"];
            console.log(_this.ChatUserList, "ChatUserList");
        });
    };
    ChatInsightComponent.prototype.zoomImg = function (key) {
        this.myKey = key;
        $("#zoom").modal("show");
    };
    ChatInsightComponent.prototype.openFile = function (val) {
        window.open(val);
    };
    ChatInsightComponent.prototype.clearChat = function () {
        if (this.userId < this.chatId) {
            var dataTosaveRecent = {
                lastMessage: "",
            };
    ...
    ChatInsightComponent.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_5__["AngularFireDatabase"] },
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(af, activatedRoute, router, api, Toast, fb) {
        this.af = af;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.api = api;
    ...
    ChatComponent.prototype.getList = function () {
        ...
        this.userData = JSON.parse(localStorage.getItem('userData'));
        this.userId = this.userData.id;
        var ref = this.af.database.ref('/recentMessage/' + this.userId);
        var that = this;
        ...
        //   }
        // );
        this.af.list('/recentMessage/' + this.userId).valueChanges().subscribe(function (data) {
            _this.AllMessagelists = data;
        });
        setTimeout(function () {
            _this.GetListfromUserState();
        }, 1500);
        this.af.list('/userState').valueChanges().subscribe(function (data) {
            _this.userStateData = data;
    ...
    //     })
    //   }
    ChatComponent.prototype.searchmethod = function (filterVal) {
        this.filterUser = filterVal;
        console.log(filterVal);
        this.chatUserarr = this.masterCopy.filter(function (a) {
    ...
    ChatComponent.prototype.applyFilter = function (filterValue) {
        this.chatUserarr = this.masterCopy.filter(function (a) {
    ...
    //   this.chatUserarr = this.masterCopy
    // }
    ChatComponent.prototype.GetListfromUserState = function () {
        var _this = this;
        var _loop_1 = function (index) {
            x = this_1.userStateData.find(function (f) {
                return _this.childKey1[index] == f.id;
            });
            if (x)
                this_1.chatUserarr.push(x);
        };
        var this_1 = this, x;
        for (var index = 0; index < (this.childKey1 || []).length; index++) {
            _loop_1(index);
        }
        var _loop_2 = function (index) {
            this_2.AllMessagelists.find(function (b) {
                if (_this.chatUserarr[index].id == b.id) {
                    _this.chatUserarr[index]['lastMessage'] = b.lastMessage;
                    _this.chatUserarr[index]['mediaType'] = b.mediaType;
                    _this.chatUserarr[index]['LastMessageTime'] = b.timeStamp;
                }
            });
        };
        var this_2 = this;
        for (var index = 0; index < (this.chatUserarr || []).length; index++) {
            _loop_2(index);
        }
        this.masterCopy = JSON.parse(JSON.stringify(this.chatUserarr));
        console.log(this.masterCopy, "masterCopy");
        var arr = this.childKey1.filter(function (e) {
            return _this.userStateData.filter(function (f) {
                return e.id == f.id;
            });
        });
    };
    ChatComponent.prototype.chatInsight = function (data) {
        this.router.navigate(['chat-insight/' + data.id]);
    };
    ChatComponent.prototype.getChatUserList = function () {
        var _this = this;
        this.api.getChatUsers().subscribe(function (a) {
            _this.ChatUserList = a['data'];
            _this.masterArr = _this.ChatUserList;
            console.log(_this.ChatUserList, "ChatUserList");
        });
    };
    ChatComponent.prototype.applyModalFilter = function (filterValues) {
        if (filterValues === '') {
            this.chatUserarr = this.masterArr;
        }
        else {
            this.tempArr = this.masterArr.filter(function (ab) { return ab.company_name.toLocaleLowerCase().includes(filterValues.toLocaleLowerCase()); });
            // return a.name.toLowerCase() == filterValue.toLowerCase()
...
var CreateProfileComponent = /** @class */ (function () {
    function CreateProfileComponent(router, service, Form, toast) {
        this.router = router;
    ...
    CreateProfileComponent.prototype.editProfile = function () {
        var _this = this;
        console.log(this.editForm.value);
        this.service.guest_signup(this.editForm.value).subscribe(function (res) {
            console.log(res);
            _this.toast.success("Your account has created successfully please login.");
            _this.router.navigate(['/']);
        }, function (error) {
...
var DisclaimerComponent = /** @class */ (function () {
    function DisclaimerComponent(api) {
        this.api = api;
    }
    DisclaimerComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.disclaimer().subscribe(function (x) {
            _this.htmlString = x.data[0].content;
            console.log(_this.htmlString);
        }, function (err) {
            console.log(err);
        });
    };
    DisclaimerComponent.ctorParameters = function () { return [
        { type: _service_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
    ]; };
...
var EditMyPostComponent = /** @class */ (function () {
    function EditMyPostComponent() {
    }
    EditMyPostComponent.prototype.ngOnInit = function () {
...
var EditProfileComponent = /** @class */ (function () {
    function EditProfileComponent(route, api, toast, Form, router) {
        this.route = route;
        this.api = api;
        this.toast = toast;
        this.Form = Form;
    ...
    EditProfileComponent.prototype.singleFiles = function (event) {
        var _this = this;
        var e_1, _a;
        this.file = event.target.files[0];
        this.single = [];
    ...
    EditProfileComponent.prototype.getProfileData = function () {
        var _this = this;
        this.api.getProfileData(this.username).subscribe(function (d) {
            _this.profiledata = d["data"];
            console.log(_this.profiledata, "profiledata23");
            console.log(_this.profiledata.name, "profile name 9999999999");
            _this.typeOfProfile = _this.profiledata.profile_type;
            if (_this.profiledata.profile_type == 1)
                _this.profiledata.profile_type = "Personal";
            else if (_this.profiledata.profile_type == 2) {
                _this.profiledata.profile_type = "Company";
                _this.Company = _this.profiledata.profile_type;
                console.log(_this.Company, "thiscompany");
            }
            else if (_this.profiledata.profile_type == 2)
                _this.profiledata.profile_type = "Company colleague";
            console.log();
            _this.companyname = _this.profiledata
                ? _this.profiledata.company_detail
                    ? _this.profiledata.company_detail["name"]
                    : ""
                : "";
            console.log(_this.companyname, "dfggggggggggggggggg");
            _this.companyDescription = _this.profiledata
                ? _this.profiledata.company_detail
                    ? _this.profiledata.company_detail["description"]
                    : ""
                : "";
            _this.editForm.patchValue({
                // name: this.profiledata ? this.profiledata.name : '',
                email: _this.profiledata ? _this.profiledata.email : "",
                mobile_number: _this.profiledata ? _this.profiledata.mobile_number : "",
                ProfileType: _this.profiledata ? _this.profiledata.profile_type : "",
                facebook: _this.profiledata ? _this.profiledata.social_links[1] : "",
                twitter: _this.profiledata ? _this.profiledata.social_links[2] : "",
                google: _this.profiledata ? _this.profiledata.social_links[4] : "",
                insta: _this.profiledata ? _this.profiledata.social_links[3] : "",
                description: _this.profiledata ? _this.profiledata.about : "",
            });
        }, function (err) {
            console.log(err);
        });
    ...
    EditProfileComponent.prototype.editProfile = function () {
        ...
        this.api.editprofile(editData).subscribe(function (res) {
            _this.toast.success("Profile Updated Successfully");
            setTimeout(function () {
...
var FaqComponent = /** @class */ (function () {
    ...
    FaqComponent.prototype.ngOnInit = function () {
        ...
        // });
        var _this = this;
        this.api.faq().subscribe(function (x) {
            console.log(x["data"]);
            _this.faqdata = x.data;
        });
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(fb, ApiService, toast, http, route, router, auth, messagingService, dataSource) {
        this.fb = fb;
        this.ApiService = ApiService;
        this.toast = toast;
        this.http = http;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        // window.location.reload()
        var geodata;
        this.subscription = this.dataSource.currentData.subscribe(function (data) { return (geodata = data); });
        //
        if (geodata.searched) {
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(function (data) {
                    ...
                    _this.current_lat = data.coords.latitude;
                    _this.current_long = data.coords.longitude;
                    localStorage.setItem("lat", _this.current_lat);
                    localStorage.setItem("long", _this.current_long);
                    console.log("lat  - " + _this.current_lat + ", long - " + _this.current_long);
                });
            }
            else {
        ...
        var userId = userData ? userData["id"] : "123";
        setTimeout(function () {
        ...
        this.new_tag.valueChanges.subscribe(function (val) {
            _this.message = val;
            _this.tagsList = [];
            _this.ApiService.getTagsList(_this.message).subscribe(function (x) {
                if (val != "") {
                    var data = x["data"];
                    console.log(data);
                    for (var i = 0; i < data.length; i++) {
                        _this.d = data[i].tag;
                        _this.tagsList.push(_this.d);
                    }
                }
                else {
                    _this.tagsList = [];
        ...
        this.userTag.valueChanges.subscribe(function (val) {
            _this.taggedUsers = val;
            _this.userTagsList = [];
            _this.ApiService.getUserTagList(_this.taggedUsers).subscribe(function (x) {
                if (val != "") {
                    var data = x["data"];
                    console.log(data, "full data");
                    for (var i = 0; i < data.length; i++) {
                        _this.userTagsList.push(data[i]);
                    }
                }
                else {
                    _this.userTagsList = [];
        ...
        this.FilterYear.valueChanges.subscribe(function (val) {
            _this.selectedYearFilter = val;
            if (_this.selectedYearFilter.length == 4) {
                _this.getHomePagedata();
            }
        });
        this.FilterArch.valueChanges.subscribe(function (val) {
            _this.selectedArchFilter = val;
            if (_this.selectedArchFilter.length == 4) {
                _this.getHomePagedata();
            }
        });
        this.FilterYear_mobile.valueChanges.subscribe(function (val) {
            _this.selectedYearFilter = val;
            if (_this.selectedYearFilter.length == 4) {
                _this.getHomePagedata();
            }
        ...
        // filter material
        this.filterMaterial.valueChanges.subscribe(function (val) {
            _this.selectedMaterialFilter = val;
            if (_this.selectedMaterialFilter.length > 3) {
                _this.getHomePagedata();
            }
        });
        // enter tag
        this.enterTag.valueChanges.subscribe(function (val) {
            _this.selectEnterTag = val;
            if (_this.selectEnterTag.length > 3) {
                _this.getHomePagedata();
            }
        });
        this.filterMaterial_mobile.valueChanges.subscribe(function (val) {
            _this.selectedMaterialFilter = val;
            if (_this.selectedMaterialFilter.length > 3) {
                _this.getHomePagedata();
            }
        ...
        // filter material
        this.filterElement.valueChanges.subscribe(function (val) {
            _this.selectedElementFilter = val;
            if (_this.selectedElementFilter.length > 3) {
                _this.getHomePagedata();
            }
        });
        this.filterElement_mobile.valueChanges.subscribe(function (val) {
            _this.selectedElementFilter = val;
            if (_this.selectedElementFilter.length > 3) {
                _this.getHomePagedata();
            }
        });
        this.FilterCity_zip.valueChanges.subscribe(function (val) {
            _this.selectedCity_zip = val;
            if (_this.selectedCity_zip.length > 4) {
                _this.getHomePagedata();
            }
        });
        this.FilterCity_zip_mobile.valueChanges.subscribe(function (val) {
            _this.selectedCity_zip = val;
            if (_this.selectedCity_zip.length > 4) {
                _this.getHomePagedata();
            }
        });
        this.Architect.valueChanges.subscribe(function (val) {
            _this.Architect_name = val;
            console.log(_this.Architect_name);
        });
        ...
        setTimeout(function () {
            _this.getFilterListData();
        }, 3000);
    };
    // save tags on click save button
    HomeComponent.prototype.saveTag = function () {
        $("#mtChip").value = "";
    };
    // For demo Function
    HomeComponent.prototype.demoFunction = function () {
    ...
    HomeComponent.prototype.addTag = function (event) {
    ...
    // mat chip
    HomeComponent.prototype.add = function (event) {
    ...
    HomeComponent.prototype.remove = function (tagg) {
        var index = this.taggs.indexOf(tagg);
        if (index >= 0) {
    ...
    HomeComponent.prototype.addUserTag = function (user) {
    ...
    // }
    // mat chip
    HomeComponent.prototype.add2 = function (event) {
        var input = event.input;
        var value = event.value;
        // if ((value || '').trim()) {
        //   this.taggs.push({name: value.trim()});
    ...
    HomeComponent.prototype.remove2 = function (user) {
        var index = this.userTaggs.indexOf(user);
        if (index >= 0) {
    ...
    HomeComponent.prototype.chooseImage = function (event) {
        var that = this;
        ...
        var _loop_1 = function (i) {
            ...
            this_1.selectedImages.push(img);
        };
        var this_1 = this;
    ...
    HomeComponent.prototype.getImageTag = function () {
        for (var i = 0; i < this.base64Image.length; i++) {
            this.imageTags.push($("#imgTag" + i).val());
        }
        // console.log(this.imageTags)
    };
    HomeComponent.prototype.removeImage = function (image, index) {
    ...
    HomeComponent.prototype.getCountryFilter = function (event) {
        this.selectedCountryFilter = event.target.value;
        this.getHomePagedata();
    };
    // 3rd catagory option start
    HomeComponent.prototype.getProjecttypeFilter = function (event) {
        //
        event.target.value;
    ...
    HomeComponent.prototype.getCategoryFilter = function (event) {
    ...
    HomeComponent.prototype.favoritePost = function () {
        this.favoriteList = "true";
        this.getHomePagedata();
    };
    HomeComponent.prototype.allPost = function () {
        this.favoriteList = "false";
        this.getHomePagedata();
    };
    HomeComponent.prototype.resetFilter = function () {
    ...
    HomeComponent.prototype.getHomePagedata = function () {
        var _this = this;
        ...
        if (this.auth.isLoggedIn()) {
            this.ApiService.getHomePageData({
                ...
                if (response["data"].posts.length === 0) {
                    ...
                    _this.toast.error("There is no posts");
                    _this.map.setZoom(7);
                    // for getting lat and of country
                    _this.ApiService.get_latlng(_this.selectedCountryFilter).subscribe(function (response) {
                        console.log(response, "lat and lng from country");
                        var lat = response.results[0].geometry.location.lat;
                        var lon = response.results[0].geometry.location.lng;
                        var filterLocation = new google.maps.LatLng(lat, lon);
                        _this.map.setCenter(filterLocation);
                    });
                }
                else {
                    $(".prop-card").css("display", "block");
                    _this.recentPosts = response["data"].latest_post;
                    _this.recentPosts = response["data"].posts;
                    _this.posts = response.data.posts;
                    _this.business_pins = response.data.business_pins;
                    _this.questionPosts = response.data.questions;
                    console.log(response["data"], "FULL DATA");
                    if (_this.selectedCountryFilter != "") {
                        _this.initMap(5);
                    }
                    else {
                        _this.initMap("");
                    ...
                    setTimeout(function () {
                        if (_this.selectedCountryFilter != "") {
                            var lat = _this.posts[0].lat;
                            var lon = _this.posts[0].lon;
                            var filterLocation = new google.maps.LatLng(lat, lon);
                            _this.map.setCenter(filterLocation);
                        }
                    }, 500);
            ...
            this.ApiService.getHomePageDataa({
                ...
                _this.recentPosts = response["data"].latest_post;
                console.log(_this.recentPosts, "selected post line no 944 ");
                _this.posts = response.data.posts;
                _this.business_pins = response.data.business_pins;
                console.log(_this.business_pins, "this is from somitra area(bussiness pins)");
                _this.questionPosts = response.data.questions;
    ...
    HomeComponent.prototype.profilePage = function (event) {
    ...
    HomeComponent.prototype.getFilterListData = function () {
        var _this = this;
        this.ApiService.getFilterListData().subscribe(function (x) {
            var data = x["data"];
            // console.log(data)
            _this.project_typeList = data.project_type;
            console.log(_this.project_typeList, " line no 786 data");
            _this.categoryList = data.category;
            console.log(_this.categoryList, "444444444444444444444444444");
            _this.countryList = data.country;
        });
    };
    HomeComponent.prototype.getBusinessflag = function (type) {
    ...
    HomeComponent.prototype.getflag = function (type, cat) {
    ...
    HomeComponent.prototype.initMap = function (searchzoomView) {
        var _this = this;
        //
        this.zoomView = 16;
        if (searchzoomView != "") {
        ...
        this.map2.addListener("click", function (mapsMouseEvent) {
            ...
            _this.map2.infowindow.close();
        });
        this.map1.addListener("click", function (mapsMouseEvent) {
            var lat = mapsMouseEvent.latLng.toJSON().lat;
            var lng = mapsMouseEvent.latLng.toJSON().lng;
            $("#map-lat").val(lat);
            $("#map-lon").val(lng);
            ...
            localStorage.setItem("newCompanyMapLat", lat);
            localStorage.setItem("newCompanyMapLng", lng);
            _this.map1.marker.infowindow.close();
        });
    ...
    HomeComponent.prototype.setMapToCurrentLocation = function (map) {
        // console.log('clicked')
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function (position) {
    ...
    HomeComponent.prototype.GetCenterLocation = function () { };
    // SetMapToCurrentLocationEvent() {
    //   this.setMapToCurrentLocation(this.map)
    //   location.reload();
    // }
    HomeComponent.prototype.bindInfoWindow = function (marker, map, infowindow, description) {
    ...
    // set post on map
    HomeComponent.prototype.setPostMarkers = function (map) {
        var _this = this;
        window.navigator.geolocation.getCurrentPosition(function (data) {
            _this.current_lat = data.coords.latitude;
            _this.current_long = data.coords.longitude;
    ...
    HomeComponent.prototype.setBusinessMarkers = function (map) {
        var mapType = new google.maps.StyledMapType(this.stylez, {
            name: "Grayscale",
        });
    ...
    HomeComponent.prototype.setBusinessMarkers2 = function (map) {
        var mapType = new google.maps.StyledMapType(this.stylez, {
            name: "Grayscale",
        });
        map.mapTypes.set("tehgrayz", mapType);
    ...
    HomeComponent.prototype.bindClickOnquestion = function (marker) {
        var that = this;
    ...
    // set question on map
    HomeComponent.prototype.setQuestionMarkers = function (map) {
    ...
    HomeComponent.prototype.clearQuestionFromMap = function () {
    ...
    HomeComponent.prototype.clearPostCreateFromMap = function () {
        for (var i = 0; i < this.markersArray.length; i++) {
            this.markersArray[i].setMap(null);
        }
        this.markersArray.length = 0;
    };
    HomeComponent.prototype.changeSliderEvent = function (event) {
        // console.log(event)
        if (event.target.checked) {
    ...
    HomeComponent.prototype.locate_marker_on_map = function (location, map) {
    ...
    HomeComponent.prototype.locate_marker_on_map2 = function (location, map) {
    ...
    HomeComponent.prototype.openQuestionDialog = function () {
        this.QuestCreateForm = this.fb.group({
    ...
    HomeComponent.prototype.saveQuestion = function (event) {
        var _this = this;
        if (!this.ApiService.checkIsLogin()) {
        ...
        this.ApiService.create_quest(this.formData).subscribe(function (response) {
            // this.toast.success(response.message);
    ...
    HomeComponent.prototype.load_create_posts = function () {
        this.api_get_project_type();
        this.api_get_project_category();
    };
    HomeComponent.prototype.validate_create_posts = function () {
    ...
    HomeComponent.prototype.api_get_project_type = function () {
        var _this = this;
        this.ApiService.getProjectType().subscribe(function (response) {
            _this.project_typeData = response["data"];
        }, function (error) {
            console.log("error", error);
            _this.loginError(error.error.message);
        });
    };
    HomeComponent.prototype.getType = function () {
        var e_2, _a;
        var id = $("#selType :selected").val();
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.project_typeData), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
                if (i.id == id) {
    ...
    HomeComponent.prototype.api_get_project_category = function () {
        var _this = this;
        this.ApiService.getProjectCategory().subscribe(function (response) {
            _this.project_categoryData = Object.values(response.data);
        }, function (error) {
            console.log("error", error);
            _this.loginError(error.error.message);
        });
    };
    HomeComponent.prototype.emptyPostForm = function () {
    ...
    HomeComponent.prototype.getStrEndDate = function () {
        if ($("#start-date").val()) {
    ...
    HomeComponent.prototype.hit = function () {
    ...
    HomeComponent.prototype.getTags = function () {
        var e_3, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.taggs), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
    ...
    //   })
    // }
    HomeComponent.prototype.getMoreValues = function (callback) {
        var _this = this;
        this.latitude = $("#map-lat").val();
        this.longitude = $("#map-lon").val();
        this.ApiService.getAddressNew({
            ...
            for (var i = 0; i < addressComponents.length; i++) {
                if (addressComponents[i].types[0] == "country") {
                    _this.country = addressComponents[i].long_name;
                }
                if (addressComponents[i].types[0] == "administrative_area_level_2") {
                    _this.city = addressComponents[i].long_name;
                }
                if (addressComponents[i].types[0] == "postal_code") {
                    _this.posttalcode = addressComponents[i].long_name;
                }
                if (addressComponents[i].types[0] == "route") {
                    _this.street = addressComponents[i].long_name;
                }
            }
            ...
            if (_this.street == undefined || _this.street == null) {
                _this.street = "N/A";
            }
            if (_this.posttalcode == undefined || _this.posttalcode == null) {
                _this.posttalcode = "000000";
            }
            console.log("===========1846===========", _this.country, _this.city, _this.posttalcode, _this.street);
            if (callback)
                callback();
        }, function (err) {
    ...
    HomeComponent.prototype.api_create_posts = function () {
        var _this = this;
        ...
        postData.append("name", this.postForm.value.name),
            ...
            this.selectedImages.map(function (img) {
        ...
        postData.append("image_tag", this.imageTags.toString()),
            ...
            this.ApiService.postsCreate(postData).subscribe(function (response) {
                _this.toast.success("success", response.message);
                _this.emptyPostForm();
    ...
    HomeComponent.prototype.submit_create_posts = function (e) {
        var _this = this;
        this.getTags();
        if (this.validate_create_posts()) {
            this.getImageTag();
            this.getStrEndDate();
            this.getMoreValues(function () {
                _this.api_create_posts();
            });
        }
    };
    HomeComponent.prototype.loginError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    HomeComponent.prototype.getlatlong = function (data) {
        var lat = data.lat;
        var lon = data.lon;
        // var options = {
    ...
    HomeComponent.prototype.SetMapToCurrentLocationEvent = function () {
    ...
    HomeComponent.prototype.getPostDetails = function (id) {
        var _this = this;
        this.ApiService.getProjectPostDetails(id).subscribe(function (x) {
            var data = x["data"];
            // console.log(data, "Post Details");
            _this.post_images = data.post_images;
            _this._albums = [];
            for (var i = 0; i < _this.post_images.length; i++) {
                var src = _this.post_images[i]["image"];
                var album = {
                    src: src,
                    caption: "",
                    thumb: src,
            ...
            _this.projectType = data.project_type.type;
            if (data.project_category == null) {
                _this.project_category = "";
            }
            else {
                _this.project_category = data.project_category.category;
            }
            _this.postname = data.name;
            _this.created_by = data.created_by_name;
            _this.postlocation = data.city + ", " + data.country + " | " + data.year;
            _this.description = data.about_post;
            _this.created_on = data.created_on;
            _this.lat = data.lat;
            _this.lon = data.lon;
            _this.report_reasons = data.report_reasons;
            _this.is_reported = data.is_reported;
            _this.total_comments = data.total_comments;
            _this.is_liked = data.is_liked;
            _this.comments = [];
            ...
            _this.total_likes = data.total_likes;
            _this.total_reported = data.total_reported;
            _this.total_shares = data.total_shares;
            _this.involvements = data.involvements;
            _this.involvements_types = data.involvements_types;
            _this.involvements_Arraykeys = Object.keys(data.involvements).reverse();
            // console.log(this.involvements_Arraykeys, "involvements_Arraykeys");
        }, function (err) {
            _this.toast.error("Something went wrong. Please try after some time");
        });
    };
    HomeComponent.prototype.reportPost = function (id) {
        console.log(id);
    };
    HomeComponent.prototype.copyLink = function () {
        console.log("");
    };
    HomeComponent.prototype.likeDislikePost = function (e) {
        console.log(e);
    };
    HomeComponent.prototype.navigateOnMap = function (a, b) {
        console.log(a);
    };
    // manufacture id submit data
    HomeComponent.prototype.manufactureSubmit = function (data) {
        var _this = this;
        this.userDataa = JSON.parse(localStorage.getItem("userData"));
        data["user_id"] = this.userDataa.id;
        console.log(data, "invite data");
        this.ApiService.create_post_invite_user(data).subscribe(function (response) {
            console.log(response);
            _this.toast.success("Invite post send successfully");
            $("#manufacture").modal("hide");
        }, function (error) { return console.log(error); });
    };
    HomeComponent.prototype.withoutLogin = function (e) {
    ...
    HomeComponent.prototype.myprofileClick = function () {
    ...
    HomeComponent.prototype.onRightClick = function () {
        return false;
    };
...
var InvolvementComponent = /** @class */ (function () {
    function InvolvementComponent(api, route, toast, Form, router, _lightbox) {
        this.api = api;
        this.route = route;
        this.toast = toast;
        this.Form = Form;
    ...
    InvolvementComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.UserData = JSON.parse(localStorage.getItem("userData"));
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.userData = _this.api.getUserData().company_detail.name;
            console.log(_this.userData, "4464646464");
            _this.getAuthUsers();
            if (!_this.userData) {
                _this.toast.error("Please login");
                _this.router.navigate(["/home"]);
                return false;
            }
            else {
                if (_this.userData.profile_type == "4") {
                    _this.toast.error("Please create your profile to see projects");
                    _this.router.navigate(["/home"]);
                    return false;
                }
                // $('#likes').modal('show')
            ...
            _this.inviteForm = _this.Form.group({
                email: [""],
            });
            ...
            if (JSON.parse(localStorage.getItem("userData")).profile_type == "2" ||
                ...
                if (JSON.parse(localStorage.getItem("userData")).business_type == 2 ||
                    JSON.parse(localStorage.getItem("userData")).business_type == 4 ||
                    JSON.parse(localStorage.getItem("userData")).business_type == 5) {
                    _this.isFullMarkForm = true;
                }
            }
            _this.getPostDetails(_this.post_id);
        });
    ...
    InvolvementComponent.prototype.openMarkInvDialog = function () {
    ...
    InvolvementComponent.prototype.submitMarkInvolvementForm = function () {
        //validate all fields
        var _this = this;
        ...
        this.api.markInvolvment(data).subscribe(function (response) {
            _this.toast.success(response["message"]);
            $("#involvement").modal("hide");
            _this.getPostDetails(_this.post_id);
        }, function (err) {
    ...
    InvolvementComponent.prototype.getPostDetails = function (id) {
        var _this = this;
        this.api.getProjectPostDetails(id).subscribe(function (x) {
            var data = x["data"];
            _this.created_by_name = data.created_by;
            console.log(_this.created_by_name, "this is myyyyyyyyyy");
            console.log(data, "Post Details");
            _this.post_images = data.post_images;
            _this._albums = [];
            for (var i = 0; i < _this.post_images.length; i++) {
                ...
                _this._albums.push(album);
                console.log(_this._albums, "post detailes from custom side");
            }
            // console.log(this.post_images)
            _this.projectType = data.project_type.type;
            if (data.project_category == null) {
            ...
            _this.created_by = data.created_by_name;
            _this.new_created_by = data.created_by;
            _this.postlocation = data.city + ", " + data.country + " | " + data.year;
            _this.description = data.about_post;
            _this.created_on = data.created_on;
            _this.lat = data.lat;
            ...
            _this.total_comments = data.total_comments;
            _this.is_liked = data.is_liked;
            console.log(_this.is_liked, "like like");
            _this.comments = [];
            var comments = data.comments;
            for (var c = 0; c < comments.length; c++) {
                _this.comments.push(comments[c]);
            ...
            _this.involvements_types = data.involvements_types;
            _this.involvements_Arraykeys = Object.keys(data.involvements).reverse();
            console.log(_this.involvements_Arraykeys, "involvements_Arraykeys");
        }, function (err) {
            _this.toast.error("This post is blocked by admin");
        });
    };
    // comment post
    // content = document.getElementById("content");
    InvolvementComponent.prototype.commentPost = function () {
        var _this = this;
    ...
    // show image
    InvolvementComponent.prototype.showImage = function (img_url) {
        console.log(img_url);
        $("#my-pic").modal("show");
        $("#show_img").attr("src", img_url);
    };
    // single like button
    InvolvementComponent.prototype.likeDislikePost = function (current_status) {
        var _this = this;
        this.getPostDetails(this.post_id);
        ...
        this.api
            ...
            _this.toast.error("Something went wrong. Please try after some time adafafaf");
        });
    };
    InvolvementComponent.prototype.likeDislikeComment = function (id, current_status) {
        var _this = this;
        if (current_status == true) {
            var final_status = false;
        }
    ...
    InvolvementComponent.prototype.navigateOnMap = function (lat, lon) {
        var _this = this;
        if (navigator.geolocation) {
            // Call getCurrentPosition with success and failure callbacks
            window.navigator.geolocation.getCurrentPosition(function (data) {
                ...
                _this.toast.error("Unable to access your current location Because you blocked it.");
            });
        }
        else {
    ...
    InvolvementComponent.prototype.commentsPostError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    InvolvementComponent.prototype.markInvError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    InvolvementComponent.prototype.CheckUploadedImage = function (event) {
        var e_1, _a;
        var file = event.target.files[0];
        var fileType = file["type"];
        var validImageTypes = ["image/gif", "image/jpeg", "image/png"];
    ...
    InvolvementComponent.prototype.reportPost = function (id) {
        var _this = this;
        console.log(id);
        this.api
            .reportPost({
            ...
            .subscribe(function (response) {
            _this.is_reported = true;
            _this.toast.success(response["message"]);
        }, function (err) {
            _this.toast.error("Something went wrong. Please try after some time");
        });
    };
    InvolvementComponent.prototype.copyLink = function () {
    ...
    InvolvementComponent.prototype.open = function (index) {
        // open lightbox
        this._lightbox.open(this._albums, index);
    };
    InvolvementComponent.prototype.close = function () {
        // close lightbox programmatically
        this._lightbox.close();
    };
    InvolvementComponent.prototype.getName = function (data) {
    ...
    InvolvementComponent.prototype.invite = function () {
        var _this = this;
        var post_id = parseInt(this.post_id);
        var postData = new FormData();
        ...
        this.api.inviteuser(postData).subscribe(function (a) {
            _this.inviteResponse = a["response"];
            _this.toast.success("sucessfull");
            console.log(_this.inviteResponse, "inviteResponse");
        }, function (error) {
            _this.toast.error(error.error.message);
            console.log(error.error.message, "errorMessage");
        });
    };
    InvolvementComponent.prototype.onItemSelect = function (item) {
        this.userId = item.id;
        console.log(this.userId, " selected Item");
    };
    InvolvementComponent.prototype.removePost = function () {
        var _this = this;
        var dataTosend = {
            post_id: this.post_id,
            sure_delete: true,
        };
        this.api.removepost(dataTosend).subscribe(function (res) {
            _this.removePostResponse = res["message"];
            console.log(_this.removePostResponse);
            _this.router.navigate(["/my-profile"]);
        }, function (error) {
            _this.toast.error(error.error.message);
        });
    };
    InvolvementComponent.prototype.getProjectData = function () {
        var _this = this;
        this.api.getProjectDetails(this.post_id).subscribe(function (res) {
            _this.ProjectData = res["data"];
            _this.postDetail = _this.ProjectData;
            _this.new1_created_by = _this.ProjectData.created_by;
            _this.createdByuser = _this.ProjectData.created_by_user;
            console.log(_this.ProjectData, "True False line 627");
        });
    };
    InvolvementComponent.prototype.navigateProfile = function () {
    ...
    InvolvementComponent.prototype.getAuthUsers = function () {
        var _this = this;
        this.taggedUsers;
        this.api.getAllauthuser().subscribe(function (x) {
            _this.taggedUsrsList = x["data"];
            console.log(_this.taggedUsrsList, "taggedUsersList");
        });
    };
    InvolvementComponent.prototype.selectedTags = function (data) {
        this.selectedTagsss = data.id;
        console.log(this.selectedTagsss, "selectedTagsss");
    };
    Object.defineProperty(InvolvementComponent.prototype, "name", {
        get: function () {
    ...
    InvolvementComponent.prototype.replySubmit = function (result) {
        console.log(result);
    };
    InvolvementComponent.prototype.getMarkInvolvement = function () {
        var _this = this;
        this.api.getInvolvement().subscribe(function (x) {
            console.log(x, "******************************************************");
            _this.markdata = x["data"];
        });
    };
    InvolvementComponent.ctorParameters = function () { return [
        { type: _service_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"] },
...
var LegalPolicyComponent = /** @class */ (function () {
    function LegalPolicyComponent() {
    }
    LegalPolicyComponent.prototype.ngOnInit = function () {
    };
...
var MarkInvolvementGalleryComponent = /** @class */ (function () {
    function MarkInvolvementGalleryComponent(route, api, toast, Form, router, http) {
        this.route = route;
        this.api = api;
        this.toast = toast;
        this.Form = Form;
    ...
    MarkInvolvementGalleryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (data) {
            console.log(data, "datassss");
            _this.userId = data["post_id"];
            console.log(_this.userId, "hhh");
        });
        this.getPostDetails();
        ...
        this.new_tag.valueChanges.subscribe(function (val) {
            _this.message = val;
            _this.tagsList = [];
            _this.api.getTagsList(_this.message).subscribe(function (x) {
                if (val != "") {
                    var data = x["data"];
                    console.log(data);
                    for (var i = 0; i < data.length; i++) {
    ...
    MarkInvolvementGalleryComponent.prototype.saveTag = function () {
        $("#mtChip").value = "";
    };
    MarkInvolvementGalleryComponent.prototype.getProjectData = function () {
        var _this = this;
        this.api.getProjectDetails(this.userId).subscribe(function (res) {
            _this.ProjectData = res["data"];
            console.log(_this.ProjectData, "Post Data");
        });
    };
    MarkInvolvementGalleryComponent.prototype.getPostDetails = function () {
        var _this = this;
        this.api.getProjectPostDetails(this.userId).subscribe(function (x) {
            var data = x["data"];
            console.log(data, "Post Details");
            _this.post_images = data.post_images;
            console.log(_this.post_images, "line");
            _this.wholeData = data;
            _this._albums = [];
            var self = _this;
            var _loop_1 = function (i_1) {
                var src = _this.post_images[i_1]["image"];
                sd = 0;
                ...
                $(".remove-pic" + i_1).click(function () {
                    $(this).closest("li").remove();
                    self.imageId.push(self.post_images[i_1]["id"]);
            ...
            var sd;
            for (var i_1 = 0; i_1 < _this.post_images.length; i_1++) {
                _loop_1(i_1);
            }
            var images = document.getElementsByClassName("imageToZoom");
            ...
            _this.postlocation = data.city + ", " + data.country + " | " + data.year;
            _this.description = data.about_post;
            _this.created_on = data.created_on_at;
            _this.lat = data.lat;
            _this.lon = data.lon;
            _this.report_reasons = data.report_reasons;
            _this.is_reported = data.is_reported;
            _this.tags = data.tags;
            console.log(_this.tags, "tagssggg");
            _this.total_comments = data.total_comments;
            _this.is_liked = data.total_likes;
            for (var i_2 = 0; i_2 < _this.tags.length; i_2++) {
                _this.taggs[i_2] = { name: _this.tags[i_2].tag };
                console.log(_this.tags[i_2].tag);
            }
            _this.comments = [];
            var comments = data.comments;
            for (var c = 0; c < comments.length; c++) {
            ...
            for (var i = 0; i < _this.tags.length; i++) {
                _this.mytags = _this.tags[i].tag + ",";
            }
            console.log("projectCategory " + _this.project_category);
            _this.editForm.patchValue({
                name: _this.postname,
                // tags: this.mytags,
                // image: this._albums,
                projectType: _this.projectType,
                projectCategory: _this.project_category,
                description: _this.description,
                country: _this.country,
                year: _this.year,
                // createdOn: this.created_on,
                city: _this.city,
                likes: _this.total_likes,
                comment: _this.total_comments,
                share: _this.total_shares,
            });
            _this.formatDate(_this.created_on);
        }, function (err) {
            _this.toast.error("Something went wrong. Please try after some time");
        });
    };
    ...
    // }
    MarkInvolvementGalleryComponent.prototype.addTag = function (event) {
        var tagName = event.target.textContent;
        var flag = false;
        for (var i = 0; i < this.taggs.length; i++) {
            if (this.taggs[i].name == tagName) {
    ...
    MarkInvolvementGalleryComponent.prototype.onEnter = function () {
        var flag = false;
        if (this.message.length > 3 && this.message != "") {
            for (var i = 0; i < this.taggs.length; i++) {
                if (this.taggs[i].name == this.message) {
    ...
    MarkInvolvementGalleryComponent.prototype.add = function (event) {
        var input = event.input;
        var value = event.value;
        if (input) {
            input.value = "";
    ...
    MarkInvolvementGalleryComponent.prototype.remove = function (tagg) {
        var index = this.taggs.indexOf(tagg);
        if (index >= 0) {
            this.taggs.splice(index, 1);
            if (this.tagsList.includes(tagg.name)) {
    ...
    MarkInvolvementGalleryComponent.prototype.getTags = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.taggs), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
    ...
    MarkInvolvementGalleryComponent.prototype.chooseImage = function (event) {
        var that = this;
        this.otherOption = true;
        var _loop_2 = function (i) {
            ...
            reader_1.onload = function () {
                that.base64Image.push(reader_1.result);
            };
    ...
    MarkInvolvementGalleryComponent.prototype.getImageTag = function () {
        for (var i = 0; i < this.base64Image.length; i++) {
            this.imageTags.push($("#imgTag" + i).val());
        }
        // console.log(this.imageTags)
    };
    MarkInvolvementGalleryComponent.prototype.removeImage = function (img, index) {
        var _this = this;
        this.image_Id = img.id;
        // alert(this.image_Id);
        console.log(this.image_Id, "image data ");
        this.api.deletePostImage(img).subscribe(function (res) {
            console.log(res, "delete image form api");
            _this.imageId.splice(index, 1);
            _this.toast.success("Image submit successfully");
            // window.location.reload()
            _this.post_images.splice(img, 1);
            console.log(_this.post_images, "line no 396");
        }, function (error) {
            _this.toast.error("image not delete");
        });
    ...
    MarkInvolvementGalleryComponent.prototype.formatDate = function (date) {
    ...
    MarkInvolvementGalleryComponent.prototype.editPost = function () {
        var _this = this;
        this.getTags();
        var editData = new FormData();
        ...
        this.api.editpost(editData, this.userId).subscribe(function (res) {
            _this.toast.success("Edit Successfull");
            setTimeout(function () {
                window.history.back();
            }, 500);
        }, function (error) {
            _this.toast.error(error.error.message, "please try again");
        });
    };
    MarkInvolvementGalleryComponent.prototype.getName = function (data) {
        this.router.navigate(["/users-profile/" + data]);
    };
    MarkInvolvementGalleryComponent.prototype.load_create_posts = function () {
        this.api_get_project_type();
        this.api_get_project_category();
    };
    MarkInvolvementGalleryComponent.prototype.api_get_project_type = function () {
        var _this = this;
        this.api.getProjectType().subscribe(function (response) {
            _this.project_typeData = response["data"];
        }, function (error) {
            console.log("error", error);
        });
    };
    MarkInvolvementGalleryComponent.prototype.api_get_project_category = function () {
        var _this = this;
        this.api.getProjectCategory().subscribe(function (response) {
            _this.project_categoryData = Object.values(response.data);
        }, function (error) {
            console.log("error", error);
        });
    };
    MarkInvolvementGalleryComponent.prototype.getType = function () {
        var e_2, _a;
        var id = $("#selType :selected").val();
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.project_typeData), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    MarkInvolvementGalleryComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        { type: _service_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    ...
    return MarkInvolvementGalleryComponent;
}());
...
var MyProfileComponent = /** @class */ (function () {
    function MyProfileComponent(api, Toast, fb) {
        this.api = api;
        this.Toast = Toast;
        this.fb = fb;
        this.selectable = true;
    ...
    MyProfileComponent.prototype.ngOnInit = function () {
        ...
        this.userTag.valueChanges.subscribe(function (val) {
            _this.taggedUsers = val;
            _this.userTagsList = [];
            _this.api.getauthuser(_this.taggedUsers).subscribe(function (x) {
                if (val != "") {
                    var data = x["data"];
                    for (var i = 0; i < data.length; i++) {
                        _this.userTagsList.push(data[i]);
    ...
    MyProfileComponent.prototype.initMap = function (searchzoomView) {
        var _this = this;
        //
        this.zoomView = 16;
        if (searchzoomView != "") {
    ...
    MyProfileComponent.prototype.locate_marker_on_map = function (location, map) {
        this.post_marker = new google.maps.Marker({
            // position: location,
            // map: map,
            animation: google.maps.Animation.DROP,
    ...
    MyProfileComponent.prototype.locate_marker_on_map2 = function (location, map) {
        this.post_marker2 = new google.maps.Marker({
            position: { lat: this.cur_lat, lng: this.cur_lng },
            map: map,
            draggable: true,
    ...
    MyProfileComponent.prototype.getColleagues = function () {
        var _this = this;
        this.api.getColleaguesProfiles().subscribe(function (x) {
            console.log(x["data"].colleague_accounts, "get colleagues data form");
            _this.colleagues = x["data"].colleague_accounts;
        });
    };
    MyProfileComponent.prototype.getNumber = function (obj) {
        var numb = this.colleagueForm.value.mobile_number.length;
        this.country_code = obj.slice(0, -numb);
    };
    MyProfileComponent.prototype.telInputObject = function (obj) {
        console.log(obj);
        obj.setCountry("in");
    };
    MyProfileComponent.prototype.hasError = function (obj) {
        console.log(obj);
    };
    MyProfileComponent.prototype.onCountryChange = function (obj) {
        console.log(obj);
    };
    MyProfileComponent.prototype.validateForm = function () {
    ...
    MyProfileComponent.prototype.createColleague = function (colleagueData) {
        var _this = this;
        this.submitted = true;
        if (this.validateForm() == true) {
            this.api.createColleaguesProfiles(colleagueData).subscribe(function (x) {
                _this.Toast.success("success", x["message"]);
                ...
                _this.Toast.error("error", err.error.message);
            });
        }
        console.log(colleagueData);
    };
    MyProfileComponent.prototype.getColleagueId = function (id) {
        console.log(id, "jfksnsojdzn");
        this.colleague_id = id;
        this.deleteColleague();
    };
    MyProfileComponent.prototype.deleteColleague = function () {
        var _this = this;
        this.api.deleteColleaguesProfiles({ id: this.colleague_id }).subscribe(function (x) {
            _this.Toast.success("Success", x["message"]);
            $("#delete").modal("hide");
            setTimeout(function () {
                window.location.reload();
    ...
    MyProfileComponent.prototype.getProfileData = function () {
        var _this = this;
        this.api.getProfileData(this.username).subscribe(function (d) {
            _this.profiledata = d["data"];
            console.log(_this.profiledata, "Profile Data");
            _this.socialLinks1 = _this.profiledata.social_links[1];
            if (_this.profiledata.company_detail) {
                _this.showName = _this.profiledata.company_detail["name"];
            }
            else {
                _this.showName = _this.profiledata.name;
            }
            _this.socialLinks2 = _this.profiledata.social_links[2];
            _this.socialLinks3 = _this.profiledata.social_links[3];
            _this.socialLinks4 = _this.profiledata.social_links[4];
    ...
    MyProfileComponent.prototype.openLink = function (data) {
        // alert(data);
        // console.log(data)
        window.open(data);
    };
    MyProfileComponent.prototype.getProject = function () {
        var _this = this;
        this.api.getProjectData(this.username).subscribe(function (d) {
            _this.projectdata = d["data"];
            console.log(_this.projectdata, "projectdata");
        }, function (err) {
            console.log(err);
        });
    };
    MyProfileComponent.prototype.postFollow = function () {
        var _this = this;
        this.api.getfollowunfollow(this.user_id).subscribe(function (d) {
            _this.followdata = d["data"];
            console.log(_this.followdata, "followdata");
            _this.followdata.followed == true ? 1 : 0;
        }, function (err) {
            console.log(err);
        });
    };
    MyProfileComponent.prototype.addUserTag = function (user) {
        var userName = user.username;
        var flag = false;
        for (var i = 0; i < this.userTaggs.length; i++) {
            if (this.userTaggs[i].username == userName) {
    ...
    MyProfileComponent.prototype.getTags = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.taggs), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
    ...
    MyProfileComponent.prototype.invite = function () {
        var _this = this;
        this.getTags();
    ...
    MyProfileComponent.prototype.api_get_project_type = function () {
        var _this = this;
        this.api.getProjectType().subscribe(function (response) {
            _this.project_typeData = response["data"];
            console.log(_this.project_typeData, "999999999999999999999999999");
        }, function (error) {
            console.log("error", error);
            _this.Toast.error(error.error.message);
        });
    };
    MyProfileComponent.prototype.getMoreValues = function (callback) {
        var _this = this;
        this.latitude = $("#map-lat").val();
        this.longitude = $("#map-lon").val();
        this.api
    ...
    MyProfileComponent.prototype.api_create_posts = function () {
        var _this = this;
        console.log("==================>", "api_create_posts", this.postForm.value);
        if (this.postForm.value.project_category == "Select Project Category") {
            this.postForm.value.project_category = "";
        ...
        postData.append("image_tag", this.imageTags.toString()),
            ...
            postData.append("zip_code", this.posttalcode),
            postData.append("street", ""),
            this.api.postsCreate(postData).subscribe(function (response) {
                _this.Toast.success("success", response.message);
                _this.emptyPostForm();
                $("#involvement").modal("hide");
                _this.ngOnInit();
    ...
    MyProfileComponent.prototype.submit_create_posts = function (e) {
        var _this = this;
        this.getTags();
        if (this.validate_create_posts()) {
            this.getImageTag();
    ...
    // save tags on click save button
    MyProfileComponent.prototype.saveTag = function () {
        $("#mtChip").value = "";
    };
    // add tag on select from list
    MyProfileComponent.prototype.addTag = function (event) {
        var tagName = event.target.textContent;
        var flag = false;
        for (var i = 0; i < this.taggs.length; i++) {
            if (this.taggs[i].name == tagName) {
    ...
    // add tag on hit enter
    MyProfileComponent.prototype.onEnter = function () {
        var flag = false;
        if (this.message.length > 3 && this.message != "") {
            for (var i = 0; i < this.taggs.length; i++) {
                if (this.taggs[i].name == this.message) {
    ...
    MyProfileComponent.prototype.add = function (event) {
        var input = event.input;
        var value = event.value;
        // if ((value || '').trim()) {
        //   this.taggs.push({name: value.trim()});
    ...
    MyProfileComponent.prototype.remove = function (tagg) {
        var index = this.taggs.indexOf(tagg);
        if (index >= 0) {
            this.taggs.splice(index, 1);
            if (this.tagsList.includes(tagg.name)) {
    ...
    // mat chip
    MyProfileComponent.prototype.removeImage = function (image, index) {
        this.base64Image.splice(index, 1);
        this.imageTags.splice(index, 1);
        this.selectedImages.splice(index, 1);
        if (this.selectedImages.length == 1) {
    ...
    MyProfileComponent.prototype.chooseImage = function (event) {
        var that = this;
        this.otherOption = true;
        var _loop_1 = function (i) {
            var img = event.target.files[i];
    ...
    MyProfileComponent.prototype.load_create_posts = function () {
        this.api_get_project_type();
        this.api_get_project_category();
    };
    MyProfileComponent.prototype.validate_create_posts = function () {
        var projTyp = this.postForm.value.project_type;
        var projCat = this.postForm.value.project_category;
        if (projTyp != "Select Project Type") {
            var project_type = this.postForm.value.project_type;
    ...
    MyProfileComponent.prototype.getImageTag = function () {
        for (var i = 0; i < this.base64Image.length; i++) {
            this.imageTags.push($("#imgTag" + i).val());
        }
        // console.log(this.imageTags)
    };
    MyProfileComponent.prototype.loginError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    MyProfileComponent.prototype.getType = function () {
        var e_2, _a;
        var id = $("#selType :selected").val();
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.project_typeData), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    MyProfileComponent.prototype.api_get_project_category = function () {
        var _this = this;
        this.api.getProjectCategory().subscribe(function (response) {
            _this.project_categoryData = Object.values(response.data);
            console.log(_this.project_categoryData, "888888888888888888888888");
        }, function (error) {
            console.log("error", error);
            _this.loginError(error.error.message);
        });
    };
    MyProfileComponent.prototype.emptyPostForm = function () {
        this.postForm.setValue({
            name: "",
            project_type: "",
            project_category: "",
    ...
    MyProfileComponent.prototype.getStrEndDate = function () {
        if ($("#start-date").val()) {
            this.strD = $("#start-date").val();
        }
        else {
    ...
    MyProfileComponent.prototype.hit = function () {
        var img_tagg = $("#creditt").val();
        this.postImageTag = img_tagg;
    };
    MyProfileComponent.prototype.onRightClick = function () {
        return false;
    };
...
var NotificationsSettingComponent = /** @class */ (function () {
    function NotificationsSettingComponent() {
    }
    NotificationsSettingComponent.prototype.ngOnInit = function () {
        this.NotificationToken = localStorage.getItem("NToken");
        console.log(this.NotificationToken, "nn");
    };
    NotificationsSettingComponent.prototype.notificationOff = function ($event) {
    ...
    return NotificationsSettingComponent;
}());
...
var NotificationsViewComponent = /** @class */ (function () {
    function NotificationsViewComponent() {
    }
    NotificationsViewComponent.prototype.ngOnInit = function () {
    };
...
var NotificationsComponent = /** @class */ (function () {
    ...
    NotificationsComponent.prototype.ngOnInit = function () {
        var UserData = this.Api.getUserData();
    ...
    NotificationsComponent.prototype.getNotifications = function (id) {
        ...
        this.Api.getNotifcations(dataTosend).subscribe(function (res) {
            _this.notificationList = res["data"];
            console.log(_this.notificationList, "NOtificationsList");
        });
    };
...
var PublicDetailedViewComponent = /** @class */ (function () {
    function PublicDetailedViewComponent(fb, ApiService, toast, http, route, router) {
        this.fb = fb;
        this.ApiService = ApiService;
        this.toast = toast;
        this.http = http;
    ...
    PublicDetailedViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.post_id = params["post_id"];
            ...
            if (!_this.userData) {
                ...
                _this.get_post(_this.post_id);
                // $("#comment").modal("show");
            }
        });
    };
    PublicDetailedViewComponent.prototype.get_post = function (post_id) {
        var _this = this;
        this.ApiService.questionDetails(post_id).subscribe(function (response) {
            _this.questionDetail = response["data"];
            console.log(_this.questionDetail, "line no 65");
            _this.commentname = _this.questionDetail.comments;
            _this.commantsImage = _this.questionDetail.comments[0].comment_by.profile_image;
            console.log(_this.questionDetail.comments, "this is 70 line");
            console.log(_this.questionDetail.comments[0].comment_by.profile_image, "this is 71 line");
            _this.comments = _this.questionDetail.comments;
            _this.is_reported = _this.questionDetail.is_reported;
        }, function (err) {
            _this.toast.error("Something went wrong. Please try after some time");
        });
    };
    PublicDetailedViewComponent.prototype.commentPost = function () {
        var _this = this;
        if (this.content && this.post_id) {
            if (this.content.value == "" || this.content.value == null) {
                this.commentsPostError("This field is required");
    ...
    PublicDetailedViewComponent.prototype.likeDislikePost = function (current_status) {
        var _this = this;
        if (current_status == true) {
            var final_status = false;
        }
    ...
    PublicDetailedViewComponent.prototype.likeDislikeComment = function (id, current_status) {
        var _this = this;
        if (current_status == true) {
            var final_status = false;
        }
    ...
    PublicDetailedViewComponent.prototype.navigateOnMap = function (lat, lon) {
        var _this = this;
        if (navigator.geolocation) {
            // Call getCurrentPosition with success and failure callbacks
            window.navigator.geolocation.getCurrentPosition(function (data) {
    ...
    PublicDetailedViewComponent.prototype.commentsPostError = function (e) {
        var _this = this;
        console.log(e);
        this.errormessage = e;
        setTimeout(function () {
    ...
    PublicDetailedViewComponent.prototype.reportPost = function (id) {
        var _this = this;
        console.log(id);
    ...
    PublicDetailedViewComponent.prototype.copyLink = function () {
    ...
    PublicDetailedViewComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _service_api_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"] },
    ...
    return PublicDetailedViewComponent;
}());
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(api, toast, Form) {
        this.api = api;
        this.toast = toast;
        this.Form = Form;
        this.submitted = false;
    ...
    SettingsComponent.prototype.sendFeedback = function () {
        var _this = this;
        if (Boolean(this.feedback) == false) {
            this.toast.error("feedback is required");
            return;
        }
        this.api.sendUserFeedback({ feedback: this.feedback }).subscribe(function (res) {
            _this.toast.success(res["message"]);
            _this.feedback = "";
            $("#close-feedbackModal").click();
        }, function (error) {
    ...
    SettingsComponent.prototype.changeUserPassword = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.api.changePassword(dataToSend).subscribe(function (res) {
            _this.toast.success(res["message"]);
            $("#cancel").click();
        }, function (error) {
            _this.toast.error(error.error.message);
    ...
    SettingsComponent.prototype.clearForm = function () {
...
var SubscriptionComponent = /** @class */ (function () {
    function SubscriptionComponent(api, router, toast, fb, af, stripeService, Location) {
        this.api = api;
        this.router = router;
        this.toast = toast;
        this.fb = fb;
    ...
    SubscriptionComponent.prototype.userState = function () {
        this.userData = JSON.parse(localStorage.getItem("userData"));
        this.userId = this.userData.id;
        var timestamp = new Date().getTime().toString();
        var dataTOSave = {
    ...
    SubscriptionComponent.prototype.proceedtopay = function () {
        var _this = this;
            ...
            this.stripeService
                ...
                if (result.token) {
                    ...
                    _this.api
                        ...
                        .subscribe(function (x) {
                        console.log(x["message"]);
                        _this.success_message = x["message"];
                        $("#checkout").modal("hide");
    ...
    SubscriptionComponent.prototype.setHome = function () {
        this.captured = true;
        localStorage.setItem("captured", this.captured);
    };
    // ======================
    SubscriptionComponent.prototype.Pricecheck = function () {
    ...
    SubscriptionComponent.prototype.getSubscriptionData = function () {
        var _this = this;
        this.api.get_subscription_plan().subscribe(function (x) {
            _this.subscriptiondata = x["data"];
            console.log(x, "this is after registration");
            _this.account_type = _this.subscriptiondata["account_type"];
            _this.add_pictures_link_to_others_posts =
                _this.subscriptiondata["add_pictures_link_to_others_posts"];
            _this.comment_on_existing_posts =
                _this.subscriptiondata["comment_on_existing_posts"];
            _this.create_posts = _this.subscriptiondata["create_posts"];
            _this.mark_involvement_in_others_posts =
                _this.subscriptiondata["mark_involvement_in_others_posts"];
            _this.users_or_account = _this.subscriptiondata["users_or_account"];
            _this.plan_name = _this.subscriptiondata["plan_name"];
            // created_on;
            // plan_desc;
            // plan_name;
            // price;
...
var TermsConditionsComponent = /** @class */ (function () {
    function TermsConditionsComponent(api) {
        this.api = api;
    }
    TermsConditionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.t().subscribe(function (x) {
            _this.htmlString = x.data[0].content;
            console.log(_this.htmlString);
        }, function (err) {
            console.log(err);
...
var UnfollowedProfileComponent = /** @class */ (function () {
    function UnfollowedProfileComponent(api, Toast, activatedRoute) {
        this.api = api;
        this.Toast = Toast;
        this.activatedRoute = activatedRoute;
    }
    UnfollowedProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    UnfollowedProfileComponent.prototype.getProfileData = function () {
        var _this = this;
        this.api.getProfileData(this.userName).subscribe(function (d) {
            console.log(d, "UserProfileData");
            console.log(_this.userName, "this is userName");
            _this.profiledata = d['data'];
            // this.profileImage = this.profiledata.company_detail.description;
            _this.description = _this.profiledata.company_detail.description;
            console.log(_this.description, "iskiii sdjfasfk asfaskfj sadfksadfj");
            console.log(_this.profiledata, "ProfileData");
            _this.id = _this.profiledata.id;
            if (_this.profiledata.profile_type == 1)
                _this.profiledata.profile_type = 'Personal';
            else if (_this.profiledata.profile_type == 2)
                _this.profiledata.profile_type = 'Company';
    ...
    UnfollowedProfileComponent.prototype.openLink = function (data) {
        if (data) {
            window.open('https://' + data);
        }
    };
    UnfollowedProfileComponent.prototype.getProject = function () {
        var _this = this;
        this.api.getProjectData(this.userName).subscribe(function (d) {
            _this.projectdata = d['data'];
    ...
    UnfollowedProfileComponent.prototype.followUnfollow = function () {
        var _this = this;
        this.userId = this.profiledata.id;
        var dataTosend = {
            user_id: this.userId
        };
        this.api.followunfollowUser(dataTosend).subscribe(function (res) {
            _this.followed = res['followed'];
            console.log(_this.followed, "truOrFalse");
            if (_this.followed == "True") {
                $('#follow').modal('show');
                setTimeout(function () {
                    $('#follow').modal('hide');
                }, 1000);
    ...
    UnfollowedProfileComponent.prototype.likeDIslike = function () {
        var _this = this;
        this.userId = this.profiledata.id;
        var dataTosend = {
            user_id: this.userId
        };
        this.api.likedislike(dataTosend).subscribe(function (res) {
            _this.likes = res['message'];
            _this.Toast.success(_this.likes);
            _this.getProfileData();
            console.log(_this.likes, "likes");
        }, function (error) {
            _this.Toast.error(error.error.message);
        });
    };
    UnfollowedProfileComponent.ctorParameters = function () { return [
        { type: src_app_service_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }
    ]; };
    ...
    return UnfollowedProfileComponent;
}());
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.get_profession = function () {
        return this.http.get(this.baseurl + "api/v1/users/profession_list");
    };
    ApiService.prototype.getAddress = function (query) {
        var _this = this;
    ...
    ApiService.prototype.getAddressFromLatLng = function (query) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    ApiService.prototype.getaddress = function (lat, lng) {
    ...
    ApiService.prototype.setUserData = function (data) {
    ...
    ApiService.prototype.sendImageInChat = function (data) {
        return this.http.post(this.baseurl + "api/v1/chat/upload_get_file", data, {
            headers: this.tokenHeader,
        });
    };
    ApiService.prototype.getNotifcations = function (data) {
